export default function TopDiscussions() {
  return (
    <div className="card-surface p-4 h-80 overflow-y-auto">
      <div className="flex flex-col">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="group cursor-pointer border-t border-border pt-4">
            <div className="flex items-center gap-2 mb-1.5">
              <div className="w-5 h-5 rounded-full bg-surface-muted border border-border flex items-center justify-center">
                <span className="text-[10px] font-bold">C</span>
              </div>
              <span className="text-xs font-semibold">VIX</span>
            </div>
            <p className="text-sm font-semibold leading-tight mb-2 group-hover:text-primary transition-colors">
