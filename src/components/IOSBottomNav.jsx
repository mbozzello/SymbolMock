...
const TABS = [
  ...
  { id: 'explore', label: 'Explore', path: null, icon: (a) => (
  ...
  { id: 'notifications', label: 'Notifications', path: null, badge: 4, icon: (a) => (
...
export default function IOSBottomNav() {
  ...
  const activeId = location.pathname === '/iostools' ? 'tools' : location.pathname === '/homeios' ? 'home' : 'home'
