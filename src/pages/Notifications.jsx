...
const RAW_NOTIFICATIONS = [
  ...
  { id: 8, type: 'mention', actor: { handle: 'StockTwitsUser', avatar: '/avatars/howard-lindzon.png' }, targetId: 'msg-200', targetPreview: 'What do you think @You about $AAPL here?', time: '1h' },
  ...
  { id: 10, type: 'mention', actor: { handle: 'CryptoBull', avatar: '/avatars/user-avatar.png' }, targetId: 'msg-201', targetPreview: 'Hey @You agree that macro is the main driver now?', time: '2h' },
