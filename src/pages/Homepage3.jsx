...
const STREAM_MESSAGES = {
  NVDA: [
    ...
    { id: 9, user: 'CloudBuilder', avatar: '/avatars/who-follow-1.png', body: 'Every hyperscaler is doubling down. $NVDA is the only game in town for training.', time: '52m', comments: 21, reposts: 7, likes: 156, topicIndex: 0 },
    { id: 10, user: 'QuantMind', avatar: '/avatars/who-follow-2.png', body: 'Inference demand is the next wave. $NVDA well positioned.', time: '1h', comments: 13, reposts: 4, likes: 88, topicIndex: 2 },
    { id: 11, user: 'HyperscaleFan', avatar: '/avatars/who-follow-3.png', body: 'MSFT, GOOGL, META all increasing AI spend. $NVDA is the enabler.', time: '1h 8m', comments: 16, reposts: 5, likes: 102, topicIndex: 0 },
    { id: 12, user: 'RampWatcher', avatar: '/avatars/who-follow-4.png', body: 'Blackwell yields improving. Production ramp ahead of schedule per some sources.', time: '1h 15m', comments: 8, reposts: 2, likes: 54, topicIndex: 1 },
    ...
    { id: 17, user: 'AICycle', avatar: '/avatars/who-follow-1.png', body: 'Training vs inference split shifting. Both segments growing.', time: '2h 12m', comments: 9, reposts: 2, likes: 61, topicIndex: 2 },
    { id: 18, user: 'BeatRaising', avatar: '/avatars/who-follow-2.png', body: 'History of under-promising. This quarter will be no different.', time: '2h 28m', comments: 22, reposts: 7, likes: 145, topicIndex: 3 },
    { id: 19, user: 'ComputeKing', avatar: '/avatars/who-follow-3.png', body: 'DGX Cloud adoption growing. Enterprise AI spend just starting.', time: '2h 45m', comments: 6, reposts: 1, likes: 39, topicIndex: 0 },
    { id: 20, user: 'NextGenChip', avatar: '/avatars/who-follow-4.png', body: 'Rubin on the roadmap. Multi-year visibility is unmatched.', time: '3h', comments: 18, reposts: 5, likes: 118, topicIndex: 1 },
    ...
    { id: 25, user: 'EarningsBull', avatar: '/avatars/who-follow-1.png', body: 'Gross margin expansion from Blackwell mix. Story intact.', time: '4h 35m', comments: 11, reposts: 3, likes: 72, topicIndex: 3 },
    { id: 26, user: 'HyperscaleSpend', avatar: '/avatars/who-follow-2.png', body: 'CapEx guides from MSFT GOOGL META all bullish for $NVDA.', time: '5h', comments: 16, reposts: 5, likes: 108, topicIndex: 0 },
    { id: 27, user: 'BlackwellSample', avatar: '/avatars/who-follow-3.png', body: 'Early Blackwell feedback positive. Performance per watt unmatched.', time: '5h 22m', comments: 10, reposts: 2, likes: 66, topicIndex: 1 },
    { id: 28, user: 'AIBuildOut', avatar: '/avatars/who-follow-4.png', body: 'AI infra build-out 2-3 year cycle. $NVDA at the center.', time: '5h 48m', comments: 8, reposts: 2, likes: 52, topicIndex: 2 },
    ...
    { id: 33, user: 'GuideUp', avatar: '/avatars/who-follow-1.png', body: 'Full year guide will be raised. No doubt.', time: '7h 42m', comments: 18, reposts: 6, likes: 124, topicIndex: 3 },
    { id: 34, user: 'DemandSustain', avatar: '/avatars/who-follow-2.png', body: 'Backlog still massive. Demand not the question.', time: '8h', comments: 7, reposts: 1, likes: 45, topicIndex: 0 },
    { id: 35, user: 'B100Timing', avatar: '/avatars/who-follow-3.png', body: 'B100 sampling to tier-1 customers. Ramp in H2.', time: '8h 28m', comments: 11, reposts: 3, likes: 76, topicIndex: 1 },
    { id: 36, user: 'CapexCycle', avatar: '/avatars/who-follow-4.png', body: 'AI capex cycle has legs. Enterprise just getting started.', time: '8h 55m', comments: 8, reposts: 2, likes: 54, topicIndex: 2 },
    ...
    { id: 41, user: 'RaiseComing', avatar: '/avatars/who-follow-1.png', body: 'Q3 guide will surprise. Data center momentum strong.', time: '11h', comments: 15, reposts: 5, likes: 102, topicIndex: 3 },
    { id: 42, user: 'CloudBuild', avatar: '/avatars/who-follow-2.png', body: 'Every cloud provider building. $NVDA the arms dealer.', time: '11h 30m', comments: 8, reposts: 2, likes: 55, topicIndex: 0 },
    { id: 43, user: 'RampOnTrack', avatar: '/avatars/who-follow-3.png', body: 'Blackwell production ramp on schedule. No delays.', time: '12h', comments: 11, reposts: 3, likes: 74, topicIndex: 1 },
    { id: 44, user: 'SpendSustain', avatar: '/avatars/who-follow-4.png', body: 'Hyperscaler AI spend doubling YoY. Sustainable.', time: '12h 35m', comments: 6, reposts: 1, likes: 39, topicIndex: 2 },
    ...
    { id: 49, user: 'BeatRaise', avatar: '/avatars/who-follow-1.png', body: 'Beat and raise quarter. Same as last 8 quarters.', time: '15h 20m', comments: 16, reposts: 5, likes: 112, topicIndex: 3 },
    { id: 50, user: 'EnterpriseAI', avatar: '/avatars/who-follow-2.png', body: 'Enterprise AI spend ramping. $NVDA Beneficiary.', time: '16h', comments: 7, reposts: 1, likes: 46, topicIndex: 0 },
    { id: 51, user: 'YieldUp', avatar: '/avatars/who-follow-3.png', body: 'Packaging yields at record. Blackwell supply improving.', time: '16h 40m', comments: 10, reposts: 3, likes: 69, topicIndex: 1 },
    { id: 52, user: 'MultiYear', avatar: '/avatars/who-follow-4.png', body: 'AI infra multi-year build. $NVDA revenue visibility strong.', time: '17h 15m', comments: 6, reposts: 1, likes: 40, topicIndex: 2 },
    ...
    { id: 57, user: 'EPSGuide', avatar: '/avatars/who-follow-1.png', body: 'EPS guide raise likely. Buyback helping too.', time: '20h', comments: 13, reposts: 4, likes: 94, topicIndex: 3 },
    { id: 58, user: 'DemandInsane', avatar: '/avatars/who-follow-2.png', body: 'Demand still exceeds supply. Allocation sold out.', time: '20h 45m', comments: 9, reposts: 2, likes: 63, topicIndex: 0 },
    { id: 59, user: 'ProdRamp', avatar: '/avatars/who-follow-3.png', body: 'Production ramp ahead of plan. Supply chain executing.', time: '21h 20m', comments: 10, reposts: 3, likes: 70, topicIndex: 1 },
    { id: 60, user: 'SpendWave', avatar: '/avatars/who-follow-4.png', body: 'AI spend wave continuing. No signs of slowdown.', time: '22h', comments: 6, reposts: 1, likes: 41, topicIndex: 2 },
    ...
    { id: 65, user: 'StreetLow', avatar: '/avatars/who-follow-1.png', body: 'Street estimates low. Easy beat.', time: '1d 2h', comments: 12, reposts: 3, likes: 86, topicIndex: 3 },
    { id: 66, user: 'HyperscaleDC', avatar: '/avatars/who-follow-2.png', body: 'Hyperscale data center build. $NVDA core.', time: '1d 3h', comments: 7, reposts: 1, likes: 51, topicIndex: 0 },
    { id: 67, user: 'ProdRamp', avatar: '/avatars/who-follow-3.png', body: 'Production ramp ahead. Supply chain executing.', time: '1d 4h', comments: 9, reposts: 2, likes: 64, topicIndex: 1 },
    { id: 68, user: 'CapexSustain', avatar: '/avatars/who-follow-4.png', body: 'Capex sustainability. No drop-off in sight.', time: '1d 5h', comments: 5, reposts: 1, likes: 37, topicIndex: 2 },
    ...
    { id: 73, user: 'RevenueBeat', avatar: '/avatars/who-follow-1.png', body: 'Revenue will beat. Guide up.', time: '1d 10h', comments: 10, reposts: 2, likes: 71, topicIndex: 3 },
    { id: 74, user: 'DemandTrend', avatar: '/avatars/who-follow-2.png', body: 'Demand trend strong. Backlog full.', time: '1d 11h', comments: 5, reposts: 1, likes: 40, topicIndex: 0 },
    { id: 75, user: 'YieldUp', avatar: '/avatars/who-follow-3.png', body: 'Yields improving. Blackwell supply up.', time: '1d 12h', comments: 7, reposts: 1, likes: 53, topicIndex: 1 },
    { id: 76, user: 'InfraSpend', avatar: '/avatars/who-follow-4.png', body: 'Infra spend from hyperscalers. $NVDA benefit.', time: '1d 13h', comments: 3, reposts: 1, likes: 32, topicIndex: 2 },
  ...
  TSLA: [
    ...
    { id: 9, user: 'AIBeliever', avatar: '/avatars/who-follow-1.png', body: 'Optimus demo was impressive. Robotics could be bigger than cars.', time: '58m', comments: 34, reposts: 9, likes: 212, topicIndex: 1 },
    { id: 10, user: 'MacroBull', avatar: '/avatars/who-follow-2.png', body: 'Rate cuts are a tailwind. $TSLA benefits from lower cap ex financing.', time: '1h', comments: 8, reposts: 2, likes: 53, topicIndex: 3 },
    { id: 11, user: 'EnergyStorage', avatar: '/avatars/who-follow-3.png', body: 'Megapack plus Optimus plus FSD. Multiple revenue streams converging.', time: '1h 14m', comments: 21, reposts: 6, likes: 156, topicIndex: 0 },
    { id: 12, user: 'RobotaxiDream', avatar: '/avatars/who-follow-4.png', body: 'August 8 could be huge. Robotaxi unveil could reset narrative.', time: '1h 28m', comments: 45, reposts: 12, likes: 289, topicIndex: 1 },
    ...
    { id: 17, user: 'TruckBull', avatar: '/avatars/who-follow-1.png', body: 'Cybertruck waitlist still long. Demand not the issue.', time: '2h 38m', comments: 9, reposts: 2, likes: 58, topicIndex: 2 },
    { id: 18, user: 'ChoppyMarkets', avatar: '/avatars/who-follow-2.png', body: 'Macro uncertainty keeping $TSLA range-bound. Earnings could break it.', time: '2h 51m', comments: 14, reposts: 4, likes: 91, topicIndex: 3 },
    { id: 19, user: 'MultiBusiness', avatar: '/avatars/who-follow-3.png', body: 'Not just a car company. Energy and robotics will matter more over time.', time: '3h', comments: 19, reposts: 5, likes: 132, topicIndex: 0 },
    { id: 20, user: 'RegulatoryHopeful', avatar: '/avatars/who-follow-4.png', body: 'China FSD approval could be catalyst. Robotaxi permits in select cities.', time: '3h 15m', comments: 22, reposts: 6, likes: 148, topicIndex: 1 },
    ...
    { id: 25, user: 'FSDRevenue', avatar: '/avatars/who-follow-1.png', body: 'FSD subscription could be $5B+ revenue. Under-appreciated.', time: '5h 35m', comments: 16, reposts: 5, likes: 112, topicIndex: 0 },
    { id: 26, user: 'RobotaxiPermits', avatar: '/avatars/who-follow-2.png', body: 'More cities approving robotaxi testing. Regulatory momentum.', time: '6h', comments: 12, reposts: 3, likes: 84, topicIndex: 1 },
    { id: 27, user: 'FleetEconomics', avatar: '/avatars/who-follow-3.png', body: 'Semi total cost of ownership beating diesel. Fleet math works.', time: '6h 30m', comments: 8, reposts: 2, likes: 52, topicIndex: 2 },
    { id: 28, user: 'VolatilityPlay', avatar: '/avatars/who-follow-4.png', body: '$220-$250 chop. Options premium juicy. Selling puts.', time: '7h', comments: 15, reposts: 4, likes: 102, topicIndex: 3 },
    ...
    { id: 33, user: 'DiversifiedRev', avatar: '/avatars/who-follow-1.png', body: 'Cars + storage + FSD + robotics. Multiple growth vectors.', time: '9h 55m', comments: 9, reposts: 2, likes: 58, topicIndex: 0 },
    { id: 34, user: 'August8', avatar: '/avatars/who-follow-2.png', body: 'August 8 Robotaxi event. Could be massive for narrative.', time: '10h 30m', comments: 35, reposts: 9, likes: 245, topicIndex: 1 },
    { id: 35, user: 'MegapackBacklog', avatar: '/avatars/who-follow-3.png', body: 'Megapack backlog 18+ months. Demand not the issue.', time: '11h', comments: 7, reposts: 1, likes: 45, topicIndex: 2 },
    { id: 36, user: 'BreakoutWatch', avatar: '/avatars/who-follow-4.png', body: 'Watching $250. Break and hold = run to $280.', time: '11h 40m', comments: 14, reposts: 4, likes: 96, topicIndex: 3 },
    ...
    { id: 41, user: 'PowerwallPlus', avatar: '/avatars/who-follow-1.png', body: 'Powerwall + solar + Megapack. Full energy stack.', time: '14h 40m', comments: 10, reposts: 2, likes: 66, topicIndex: 0 },
    { id: 42, user: 'DriverlessSoon', avatar: '/avatars/who-follow-2.png', body: 'Driverless approval in more states. Expansion continues.', time: '15h 20m', comments: 19, reposts: 5, likes: 132, topicIndex: 1 },
    { id: 43, user: 'FleetAdoption', avatar: '/avatars/who-follow-3.png', body: 'More fleets ordering Semi. Word of mouth positive.', time: '16h', comments: 7, reposts: 1, likes: 47, topicIndex: 2 },
    { id: 44, user: 'Support220', avatar: '/avatars/who-follow-4.png', body: '$220 support holding. Accumulating on dips.', time: '16h 45m', comments: 11, reposts: 3, likes: 74, topicIndex: 3 },
    ...
    { id: 49, user: 'ThreePillars', avatar: '/avatars/who-follow-1.png', body: 'EV + Energy + AI. Three pillars of growth.', time: '19h 50m', comments: 12, reposts: 3, likes: 86, topicIndex: 0 },
    { id: 50, user: 'PermitMomentum', avatar: '/avatars/who-follow-2.png', body: 'Robotaxi permits expanding. California leading.', time: '20h 30m', comments: 13, reposts: 4, likes: 94, topicIndex: 1 },
    { id: 51, user: 'Class8Orders', avatar: '/avatars/who-follow-3.png', body: 'Class 8 truck orders up. Semi well positioned.', time: '21h', comments: 5, reposts: 1, likes: 36, topicIndex: 2 },
    { id: 52, user: 'RangeTrade', avatar: '/avatars/who-follow-4.png', body: 'Trading the range. Sell $248, buy $225.', time: '21h 45m', comments: 10, reposts: 2, likes: 70, topicIndex: 3 },
    ...
    { id: 57, user: 'RevenueStreams', avatar: '/avatars/who-follow-1.png', body: 'Multiple revenue streams converging. Story intact.', time: '1d 1h', comments: 8, reposts: 2, likes: 52, topicIndex: 0 },
    { id: 58, user: 'TimelineClarity', avatar: '/avatars/who-follow-2.png', body: 'Robotaxi timeline clarifying. 2026-2027 deployment.', time: '1d 2h', comments: 14, reposts: 4, likes: 98, topicIndex: 1 },
    { id: 59, user: 'ProductionScale', avatar: '/avatars/who-follow-3.png', body: 'Semi production scaling. No major issues.', time: '1d 3h', comments: 5, reposts: 1, likes: 35, topicIndex: 2 },
    { id: 60, user: 'EarningsKey', avatar: '/avatars/who-follow-4.png', body: 'Next earnings could break range. Delivery guide key.', time: '1d 4h', comments: 12, reposts: 3, likes: 84, topicIndex: 3 },
    ...
    { id: 65, user: 'MultiVector', avatar: '/avatars/who-follow-1.png', body: 'Multiple growth vectors. Energy + auto + AI.', time: '1d 9h', comments: 5, reposts: 1, likes: 38, topicIndex: 0 },
    { id: 66, user: 'StorageTAM', avatar: '/avatars/who-follow-2.png', body: 'Storage TAM expanding. $TSLA well positioned.', time: '1d 10h', comments: 7, reposts: 1, likes: 50, topicIndex: 0 },
  ],
  AAPL: [
    ...
    { id: 5, user: 'DividendChaser', avatar: '/avatars/who-follow-1.png', body: 'Yield plus buyback is compelling. $AAPL cash flow machine.', time: '28m', comments: 11, reposts: 3, likes: 69, topicIndex: 3 },
    { id: 6, user: 'AIWatcher', avatar: '/avatars/who-follow-2.png', body: 'Apple Intelligence rollout could be a sleeper catalyst for upgrades.', time: '35m', comments: 19, reposts: 5, likes: 124, topicIndex: 1 },
    { id: 7, user: 'MarginBull', avatar: '/avatars/who-follow-3.png', body: 'Gross margin expansion from services mix. Story is playing out.', time: '48m', comments: 6, reposts: 1, likes: 38, topicIndex: 0 },
    { id: 8, user: 'ValuationGuy', avatar: '/avatars/who-follow-4.png', body: 'Trading at 28x vs historical. Fair value here with optionality.', time: '1h', comments: 14, reposts: 4, likes: 91, topicIndex: 3 },
    ...
    { id: 13, user: 'MarginStory', avatar: '/avatars/who-follow-1.png', body: 'Hardware margins flat, services up. That\'s the thesis.', time: '2h 5m', comments: 8, reposts: 1, likes: 52, topicIndex: 0 },
    { id: 14, user: 'AsiaSales', avatar: '/avatars/who-follow-2.png', body: 'Greater China down but India and rest of Asia growing. Mix shift.', time: '2h 18m', comments: 13, reposts: 4, likes: 94, topicIndex: 1 },
    { id: 15, user: 'CashReturn', avatar: '/avatars/who-follow-3.png', body: 'Dividend bump coming? Shareholders pushing for more return.', time: '2h 35m', comments: 11, reposts: 3, likes: 76, topicIndex: 3 },
    { id: 16, user: 'UpgradeCycle', avatar: '/avatars/who-follow-4.png', body: 'AI features could drive iPhone 17 upgrade cycle. Watching closely.', time: '2h 48m', comments: 19, reposts: 6, likes: 142, topicIndex: 1 },
    ...
    { id: 25, user: 'MarginExpand', avatar: '/avatars/who-follow-1.png', body: 'Gross margin expansion from services. Story playing out.', time: '6h 40m', comments: 7, reposts: 1, likes: 48, topicIndex: 0 },
    { id: 26, user: 'IndiaGrowth', avatar: '/avatars/who-follow-2.png', body: 'India growing double digits. Offsetting China.', time: '7h 15m', comments: 13, reposts: 4, likes: 92, topicIndex: 1 },
    { id: 27, user: 'BuybackPace', avatar: '/avatars/who-follow-3.png', body: '$90B buyback annualized. Shrinking share count.', time: '7h 55m', comments: 12, reposts: 3, likes: 86, topicIndex: 2 },
    { id: 28, user: 'UpgradeCycle', avatar: '/avatars/who-follow-4.png', body: 'iPhone 17 cycle could be strong. AI features driving.', time: '8h 30m', comments: 15, reposts: 4, likes: 108, topicIndex: 3 },
    ...
    { id: 33, user: 'iCloudGrowth', avatar: '/avatars/who-follow-1.png', body: 'iCloud storage rev growing. Recurring revenue.', time: '12h', comments: 6, reposts: 1, likes: 42, topicIndex: 0 },
    { id: 34, user: 'LocalComp', avatar: '/avatars/who-follow-2.png', body: 'Xiaomi and others in China. But premium segment holds.', time: '12h 45m', comments: 11, reposts: 3, likes: 78, topicIndex: 1 },
    { id: 35, user: 'YieldPlus', avatar: '/avatars/who-follow-3.png', body: 'Yield plus buyback. Better than bond for long term.', time: '13h 30m', comments: 8, reposts: 2, likes: 58, topicIndex: 2 },
    { id: 36, user: 'DeviceEcosystem', avatar: '/avatars/who-follow-4.png', body: 'Watch, AirPods, Mac. All connected. Sticky.', time: '14h 20m', comments: 12, reposts: 3, likes: 84, topicIndex: 3 },
    ...
    { id: 41, user: 'ServiceMargin', avatar: '/avatars/who-follow-1.png', body: 'Services margin 70%+. Driving overall margin up.', time: '18h 35m', comments: 7, reposts: 1, likes: 50, topicIndex: 0 },
    { id: 42, user: 'GreaterChina', avatar: '/avatars/who-follow-2.png', body: 'Greater China 20% of rev. Key region to watch.', time: '19h 30m', comments: 12, reposts: 3, likes: 88, topicIndex: 1 },
    { id: 43, user: 'DividendGrowth', avatar: '/avatars/who-follow-3.png', body: 'Dividend growing 4% per year. Sustainable.', time: '20h 25m', comments: 8, reposts: 2, likes: 59, topicIndex: 2 },
    { id: 44, user: 'FamilySharing', avatar: '/avatars/who-follow-4.png', body: 'Family Sharing drives retention. Multi-device households.', time: '21h 20m', comments: 9, reposts: 2, likes: 65, topicIndex: 3 },
    ...
    { id: 49, user: 'RevMix', avatar: '/avatars/who-follow-1.png', body: 'Revenue mix shifting to services. Less cyclical.', time: '1d 2h', comments: 5, reposts: 1, likes: 36, topicIndex: 0 },
    { id: 50, user: 'AsiaPac', avatar: '/avatars/who-follow-2.png', body: 'Rest of Asia growing. India, Korea, Japan.', time: '1d 3h', comments: 11, reposts: 3, likes: 80, topicIndex: 1 },
    { id: 51, user: 'ReturnShareholders', avatar: '/avatars/who-follow-3.png', body: 'Returning cash to shareholders. No wasteful M&A.', time: '1d 4h', comments: 9, reposts: 2, likes: 64, topicIndex: 2 },
    { id: 52, user: 'Integration', avatar: '/avatars/who-follow-4.png', body: 'Devices work together seamlessly. Ecosystem advantage.', time: '1d 5h', comments: 10, reposts: 2, likes: 68, topicIndex: 3 },
    ...
    { id: 57, user: 'MarginStory', avatar: '/avatars/who-follow-1.png', body: 'Services driving margin expansion. Multi-year trend.', time: '1d 10h', comments: 5, reposts: 1, likes: 39, topicIndex: 0 },
    { id: 58, user: 'StimulusHope', avatar: '/avatars/who-follow-2.png', body: 'China stimulus could boost consumer. Watching.', time: '1d 11h', comments: 11, reposts: 3, likes: 77, topicIndex: 1 },
    { id: 59, user: 'TotalReturn', avatar: '/avatars/who-follow-3.png', body: 'Yield + buyback + growth = total return.', time: '1d 12h', comments: 8, reposts: 2, likes: 58, topicIndex: 2 },
    { id: 60, user: 'CrossSell', avatar: '/avatars/who-follow-4.png', body: 'Cross-sell across devices. Watch to iPhone to Mac.', time: '1d 13h', comments: 7, reposts: 1, likes: 49, topicIndex: 3 },
    ...
    { id: 65, user: 'YieldStory', avatar: '/avatars/who-follow-1.png', body: 'Yield plus growth. Rare combo in mega-cap.', time: '1d 18h', comments: 10, reposts: 2, likes: 71, topicIndex: 2 },
    { id: 66, user: 'CapitalReturn', avatar: '/avatars/who-follow-2.png', body: 'Capital return program largest in tech.', time: '1d 19h', comments: 7, reposts: 1, likes: 50, topicIndex: 2 },
    { id: 67, user: 'NetCash', avatar: '/avatars/who-follow-3.png', body: 'Net cash position. Optionality for M&A or return.', time: '1d 20h', comments: 9, reposts: 2, likes: 65, topicIndex: 2 },
    { id: 68, user: 'TotalReturn', avatar: '/avatars/who-follow-4.png', body: 'Total return via div + buyback + appreciation.', time: '1d 21h', comments: 8, reposts: 1, likes: 54, topicIndex: 2 },
  ...
  AMD: [
    ...
    { id: 5, user: 'InstinctBull', avatar: '/avatars/who-follow-1.png', body: 'Instinct MI300X shipping to hyperscalers. $AMD playing catch-up but executing.', time: '23m', comments: 16, reposts: 5, likes: 105, topicIndex: 1 },
    { id: 6, user: 'ValueSemi', avatar: '/avatars/who-follow-2.png', body: 'Better value than NVDA at current multiples. Both can win in AI.', time: '38m', comments: 9, reposts: 2, likes: 62, topicIndex: 3 },
    { id: 7, user: 'GamingRevival', avatar: '/avatars/who-follow-3.png', body: 'RDNA 4 looking solid. Gaming bottomed. Data center is the growth story.', time: '51m', comments: 7, reposts: 1, likes: 44, topicIndex: 2 },
    { id: 8, user: 'AICycle', avatar: '/avatars/who-follow-4.png', body: 'AI build-out is multi-year. $AMD has room to run from here.', time: '1h', comments: 12, reposts: 3, likes: 78, topicIndex: 0 },
    ...
    { id: 13, user: 'InstinctDemand', avatar: '/avatars/who-follow-1.png', body: 'MI300 capacity allocation sold out. Demand > supply.', time: '2h 25m', comments: 17, reposts: 5, likes: 116, topicIndex: 0 },
    { id: 14, user: 'HyperscaleDiversify', avatar: '/avatars/who-follow-2.png', body: 'Hyperscalers want second source. $AMD is the only real option.', time: '2h 42m', comments: 11, reposts: 3, likes: 82, topicIndex: 1 },
    { id: 15, user: 'RaiseExpect', avatar: '/avatars/who-follow-3.png', body: 'Next quarter guide will likely be raised again. Data center momentum strong.', time: '2h 58m', comments: 9, reposts: 2, likes: 61, topicIndex: 2 },
    { id: 16, user: 'PCGaming', avatar: '/avatars/who-follow-4.png', body: 'Client and gaming stable. Not the growth driver but not a drag.', time: '3h 15m', comments: 6, reposts: 1, likes: 39, topicIndex: 3 },
    ...
    { id: 25, user: 'InstinctAdoption', avatar: '/avatars/who-follow-1.png', body: 'Instinct adoption from hyperscalers. Real demand.', time: '7h 20m', comments: 11, reposts: 3, likes: 76, topicIndex: 0 },
    { id: 26, user: 'DataCenterMix', avatar: '/avatars/who-follow-2.png', body: 'Data center mix shifting. Inference opportunity.', time: '8h', comments: 9, reposts: 2, likes: 62, topicIndex: 1 },
    { id: 27, user: 'RaiseLikely', avatar: '/avatars/who-follow-3.png', body: 'Next quarter guide raise likely. Momentum strong.', time: '8h 45m', comments: 10, reposts: 2, likes: 69, topicIndex: 2 },
    { id: 28, user: 'ExecutionTrack', avatar: '/avatars/who-follow-4.png', body: 'Execution on track. No surprises.', time: '9h 35m', comments: 6, reposts: 1, likes: 42, topicIndex: 3 },
    ...
    { id: 33, user: 'MI300X', avatar: '/avatars/who-follow-1.png', body: 'MI300X in production. Shipments growing.', time: '14h', comments: 12, reposts: 3, likes: 84, topicIndex: 0 },
    { id: 34, user: 'InferencePlay', avatar: '/avatars/who-follow-2.png', body: 'Inference is the play. Lower power, good perf.', time: '14h 55m', comments: 9, reposts: 2, likes: 64, topicIndex: 1 },
    { id: 35, user: 'DataCenterGuide', avatar: '/avatars/who-follow-3.png', body: 'Data center guide will be raised. Momentum.', time: '15h 50m', comments: 10, reposts: 2, likes: 71, topicIndex: 2 },
    { id: 36, user: 'SegmentExecution', avatar: '/avatars/who-follow-4.png', body: 'All segments executing. Client, gaming, DC.', time: '16h 50m', comments: 6, reposts: 1, likes: 44, topicIndex: 3 },
    ...
    { id: 41, user: 'CapacitySold', avatar: '/avatars/who-follow-1.png', body: 'MI300 capacity sold out. Demand > supply.', time: '22h 45m', comments: 10, reposts: 2, likes: 72, topicIndex: 0 },
    { id: 42, user: 'DiversifySpend', avatar: '/avatars/who-follow-2.png', body: 'Hyperscalers diversifying. $AMD beneficiary.', time: '1d', comments: 7, reposts: 1, likes: 49, topicIndex: 1 },
    { id: 43, user: 'UpsideGuide', avatar: '/avatars/who-follow-3.png', body: 'Full year guide has upside. Data center strong.', time: '1d 1h', comments: 11, reposts: 3, likes: 80, topicIndex: 2 },
    { id: 44, user: 'OperationalLean', avatar: '/avatars/who-follow-4.png', body: 'Operationally lean. Margins expanding.', time: '1d 2h', comments: 6, reposts: 1, likes: 43, topicIndex: 3 },
    ...
    { id: 49, user: 'DemandStrong', avatar: '/avatars/who-follow-1.png', body: 'MI300 demand strong. Allocation tight.', time: '1d 7h', comments: 12, reposts: 3, likes: 88, topicIndex: 0 },
    { id: 50, user: 'ShareStory', avatar: '/avatars/who-follow-2.png', body: 'Share gain story in inference. Multi-year.', time: '1d 8h', comments: 9, reposts: 2, likes: 65, topicIndex: 1 },
    { id: 51, user: 'GuideConservative', avatar: '/avatars/who-follow-3.png', body: 'Guide always beatable. Sandbagging.', time: '1d 9h', comments: 11, reposts: 3, likes: 79, topicIndex: 2 },
    { id: 52, user: 'MarginStory', avatar: '/avatars/who-follow-4.png', body: 'Margin expansion from data center mix.', time: '1d 10h', comments: 6, reposts: 1, likes: 44, topicIndex: 3 },
    ...
    { id: 57, user: 'HypserscaleDC', avatar: '/avatars/who-follow-1.png', body: 'Hyperscaler data center penetration growing.', time: '1d 15h', comments: 9, reposts: 2, likes: 67, topicIndex: 0 },
    { id: 58, user: 'InferenceTAM', avatar: '/avatars/who-follow-2.png', body: 'Inference TAM growing faster than training.', time: '1d 16h', comments: 7, reposts: 1, likes: 51, topicIndex: 1 },
    { id: 59, user: 'FullYearUp', avatar: '/avatars/who-follow-3.png', body: 'Full year guide will go up. Data center.', time: '1d 17h', comments: 10, reposts: 2, likes: 71, topicIndex: 2 },
    { id: 60, user: 'CostDiscipline', avatar: '/avatars/who-follow-4.png', body: 'Cost discipline. Op efficiency.', time: '1d 18h', comments: 6, reposts: 1, likes: 45, topicIndex: 3 },
  ],
  AMZN: [
    ...
    { id: 5, user: 'AdRevenue', avatar: '/avatars/who-follow-1.png', body: 'Advertising revenue up 25% YoY. $AMZN becoming an ad company too.', time: '33m', comments: 18, reposts: 5, likes: 116, topicIndex: 2 },
    { id: 6, user: 'CapExWatcher', avatar: '/avatars/who-follow-2.png', body: 'Infrastructure spend disciplined. AWS margins expanding.', time: '44m', comments: 8, reposts: 2, likes: 55, topicIndex: 0 },
    { id: 7, user: 'PrimeSub', avatar: '/avatars/who-follow-3.png', body: 'Prime membership growth steady. Streaming + delivery = sticky.', time: '56m', comments: 10, reposts: 3, likes: 71, topicIndex: 1 },
    { id: 8, user: 'EcommerceBull', avatar: '/avatars/who-follow-4.png', body: '3P seller growth accelerating. Marketplace take rate improving.', time: '1h', comments: 6, reposts: 1, likes: 39, topicIndex: 3 },
    ...
    { id: 13, user: 'CloudShare', avatar: '/avatars/who-follow-1.png', body: 'AWS still 32% of cloud. Taking share from smaller players.', time: '2h 25m', comments: 10, reposts: 2, likes: 73, topicIndex: 0 },
    { id: 14, user: 'VideoAds', avatar: '/avatars/who-follow-2.png', body: 'Thursday Night Football ads. Video ad inventory growing.', time: '2h 42m', comments: 9, reposts: 2, likes: 62, topicIndex: 2 },
    { id: 15, user: 'PrimeValue', avatar: '/avatars/who-follow-3.png', body: 'Prime price increase absorbed. Churn didn\'t spike.', time: '2h 58m', comments: 11, reposts: 3, likes: 79, topicIndex: 1 },
    { id: 16, user: 'CapitalReturn', avatar: '/avatars/who-follow-4.png', body: 'Buying back stock. Cash flow supports it.', time: '3h 15m', comments: 7, reposts: 1, likes: 48, topicIndex: 3 },
    ...
    { id: 25, user: 'CloudShare', avatar: '/avatars/who-follow-1.png', body: 'AWS 32% of cloud. Taking share.', time: '7h 25m', comments: 11, reposts: 3, likes: 76, topicIndex: 0 },
    { id: 26, user: 'SponsoredProducts', avatar: '/avatars/who-follow-2.png', body: 'Sponsored products revenue up 25%. Under-monetized.', time: '8h 15m', comments: 9, reposts: 2, likes: 62, topicIndex: 1 },
    { id: 27, user: 'RegionalFulfill', avatar: '/avatars/who-follow-3.png', body: 'Regional fulfillment centers. Faster delivery.', time: '9h 10m', comments: 7, reposts: 1, likes: 48, topicIndex: 2 },
    { id: 28, user: 'CapExEfficiency', avatar: '/avatars/who-follow-4.png', body: 'CapEx efficiency improving. ROI on infra.', time: '10h', comments: 10, reposts: 2, likes: 70, topicIndex: 3 },
    ...
    { id: 33, user: 'GenAIWorkload', avatar: '/avatars/who-follow-1.png', body: 'GenAI workloads on AWS. Inferentia, Trainium.', time: '15h 25m', comments: 14, reposts: 4, likes: 98, topicIndex: 0 },
    { id: 34, user: 'AdInventory', avatar: '/avatars/who-follow-2.png', body: 'Ad inventory growing. Prime, Fire TV.', time: '16h 45m', comments: 7, reposts: 1, likes: 49, topicIndex: 1 },
    { id: 35, user: 'MarginImprove', avatar: '/avatars/who-follow-3.png', body: 'Retail margins improving. Mix shift.', time: '18h 10m', comments: 9, reposts: 2, likes: 64, topicIndex: 2 },
    { id: 36, user: 'OpCashFlow', avatar: '/avatars/who-follow-4.png', body: 'Operating cash flow growth. Sustainable.', time: '19h 40m', comments: 10, reposts: 2, likes: 72, topicIndex: 3 },
    ...
    { id: 41, user: 'AWSMargin', avatar: '/avatars/who-follow-1.png', body: 'AWS margins expanding. Scale benefits.', time: '1d 2h', comments: 12, reposts: 3, likes: 86, topicIndex: 0 },
    { id: 42, user: 'Monetization', avatar: '/avatars/who-follow-2.png', body: 'Ad monetization early. Big runway.', time: '1d 3h', comments: 7, reposts: 1, likes: 50, topicIndex: 1 },
    { id: 43, user: 'UnitEconomics', avatar: '/avatars/who-follow-3.png', body: 'Unit economics improving. Per-unit cost down.', time: '1d 4h', comments: 6, reposts: 1, likes: 44, topicIndex: 2 },
    { id: 44, user: 'FCFGrowth', avatar: '/avatars/who-follow-4.png', body: 'FCF growth reaccelerating. Story intact.', time: '1d 5h', comments: 11, reposts: 3, likes: 79, topicIndex: 3 },
    ...
    { id: 49, user: 'Inferentia', avatar: '/avatars/who-follow-1.png', body: 'Inferentia for AI. Custom silicon payoff.', time: '1d 10h', comments: 9, reposts: 2, likes: 63, topicIndex: 0 },
    { id: 50, user: 'AdRevenue', avatar: '/avatars/who-follow-2.png', body: 'Ad revenue growth 20%+. Key driver.', time: '1d 11h', comments: 6, reposts: 1, likes: 46, topicIndex: 1 },
    { id: 51, user: 'DeliverySpeed', avatar: '/avatars/who-follow-3.png', body: 'Delivery speed improving. Same-day expanding.', time: '1d 12h', comments: 8, reposts: 2, likes: 59, topicIndex: 2 },
    { id: 52, user: 'CashMachine', avatar: '/avatars/who-follow-4.png', body: 'Cash flow machine. Ads + AWS = margin.', time: '1d 13h', comments: 10, reposts: 2, likes: 73, topicIndex: 3 },
    ...
    { id: 57, user: 'AWSGenAI', avatar: '/avatars/who-follow-1.png', body: 'AWS GenAI products. Bedrock adoption.', time: '1d 18h', comments: 11, reposts: 3, likes: 81, topicIndex: 0 },
    { id: 58, user: 'CTRGrowth', avatar: '/avatars/who-follow-2.png', body: 'CTR growth in ads. Optimization.', time: '1d 19h', comments: 4, reposts: 1, likes: 35, topicIndex: 1 },
    { id: 59, user: 'FulfillmentOpt', avatar: '/avatars/who-follow-3.png', body: 'Fulfillment optimization. Robotics.', time: '1d 20h', comments: 7, reposts: 1, likes: 53, topicIndex: 2 },
    { id: 60, user: 'MarginExpand', avatar: '/avatars/who-follow-4.png', body: 'Margin expansion from ads + AWS. Multi-year.', time: '1d 21h', comments: 9, reposts: 2, likes: 68, topicIndex: 3 },
  ],
}
...
const LOAD_IN_MESSAGES = {
  TSLA: [
    ...
    { id: 90005, user: 'EnergyBull', avatar: '/avatars/who-follow-1.png', body: 'Megapack order from utility. Storage demand insane.', time: '2m', comments: 4, reposts: 1, likes: 28, topicIndex: 0 },
    { id: 90006, user: 'SemiFleet', avatar: '/avatars/who-follow-2.png', body: 'Pepsi just added 50 more Semis. Fleet expansion accelerating.', time: '2m', comments: 6, reposts: 2, likes: 39, topicIndex: 2 },
  ],
  NVDA: [
    ...
    { id: 90005, user: 'HyperscaleSpend', avatar: '/avatars/who-follow-1.png', body: 'MSFT guide beat. More AI spend. $NVDA wins.', time: '2m', comments: 7, reposts: 2, likes: 48, topicIndex: 0 },
    { id: 90006, user: 'SupplyChain', avatar: '/avatars/who-follow-2.png', body: 'CoWoS capacity expanding. Supply no longer constraint.', time: '2m', comments: 2, reposts: 0, likes: 15, topicIndex: 1 },
  ],
  AAPL: [
    ...
    { id: 90005, user: 'ServicesMargin', avatar: '/avatars/who-follow-1.png', body: 'App Store margins expanding. Recurring rev growing.', time: '2m', comments: 3, reposts: 0, likes: 21, topicIndex: 0 },
    { id: 90006, user: 'DividendYield', avatar: '/avatars/who-follow-2.png', body: 'Yield plus buyback. Total return compelling.', time: '2m', comments: 6, reposts: 2, likes: 41, topicIndex: 2 },
  ],
  AMD: [
    ...
    { id: 90005, user: 'InstinctDemand', avatar: '/avatars/who-follow-1.png', body: 'MI300X allocations sold out. Demand > supply.', time: '2m', comments: 4, reposts: 1, likes: 31, topicIndex: 0 },
    { id: 90006, user: 'BeatExpect', avatar: '/avatars/who-follow-2.png', body: 'Quarter will beat. Guide raised again.', time: '2m', comments: 7, reposts: 2, likes: 52, topicIndex: 2 },
  ],
  AMZN: [
    ...
    { id: 90005, user: 'BedrockAdoption', avatar: '/avatars/who-follow-1.png', body: 'Bedrock adoption accelerating. Enterprise AI.', time: '2m', comments: 6, reposts: 2, likes: 45, topicIndex: 0 },
    { id: 90006, user: 'MarginExpand', avatar: '/avatars/who-follow-2.png', body: 'Ads + AWS margin expansion. Multi-year trend.', time: '2m', comments: 3, reposts: 0, likes: 21, topicIndex: 3 },
  ],
}
