...
export default function SymbolDiscover2() {
      ...
      <main className="lg:pl-[350px]">
        ...
        <div className="max-w-[1200px] mx-auto pl-0 pr-0 py-4 flex gap-0">
          ...
          <div className="flex-1 min-w-0 max-w-[660px] pl-0 pr-0">
            <SymbolHeaderAbovePostBox symbol={symbol} variant="predict" hideNo enableBetting showContentPill combineCarousel />
            <div className="px-3">
            ...
            {[
              ...
              { id: 'feed-debate-1', username: 'BearCaseKing', avatar: '/avatars/michael-bolling.png', time: '9m', body: 'Tesla will go to zero by EOY because Elon is a clown. Fight me.', sentiment: 'bearish', comments: 312, reposts: 87, likes: 1420, hasReaction: true, debate: { thumbsUp: 186, thumbsDown: 891, upVoters: [{ id: 'u1', username: 'EVSkeptic', avatar: '/avatars/top-voice-1.png' }, { id: 'u2', username: 'ShortSeller', avatar: '/avatars/top-voice-2.png' }, { id: 'u3', username: 'BearishDave', avatar: '/avatars/ross-cameron.png' }, { id: 'u4', username: 'MacroBear', avatar: '/avatars/michael-bolling.png' }, { id: 'u5', username: 'RealityCheck', avatar: '/avatars/michele-steele.png' }], downVoters: [{ id: 'd1', username: 'ElonFan', avatar: '/avatars/top-voice-2.png' }, { id: 'd2', username: 'TeslaBull', avatar: '/avatars/howard-lindzon.png' }, { id: 'd3', username: 'FSDLover', avatar: '/avatars/top-voice-3.png' }, { id: 'd4', username: 'AIBeliever', avatar: '/avatars/top-voice-1.png' }, { id: 'd5', username: 'GrowthHawk', avatar: '/avatars/user-avatar.png' }] } },
