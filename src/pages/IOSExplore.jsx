...
export default function IOSExplore() {
  ...
  return (
    <div className="mx-auto max-w-[430px] h-screen flex flex-col overflow-hidden bg-white text-gray-900 relative" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Helvetica Neue", sans-serif' }}>
          ...
          <div className="flex items-center justify-between px-6 pt-3 pb-1">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <div className="flex items-center gap-0.5">
                <div className="w-7 h-3.5 rounded-sm border border-gray-300 flex items-center p-px">
      ...
      {!isForYouPage && (
      <div className="shrink-0 flex items-center gap-2 px-3 py-2 border-b border-gray-200">
        {!searchExpanded ? (
          <>
            {/* Hamburger */}
            ...
            <div className="flex-1 relative">
              <svg className="absolute left-2.5 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 pointer-events-none" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><circle cx="11" cy="11" r="8"/><path d="M21 21l-4.35-4.35"/></svg>
              <input
                ref={searchRef}
                type="text"
                value={search}
                ...
                className="w-full bg-gray-200 rounded-full pl-8 pr-3 py-2 text-sm text-gray-900 placeholder:text-gray-400 outline-none focus:ring-1 focus:ring-[#2196F3]/50"
              />
            </div>
          ...
          <>
            ...
            <div className="flex-1 relative">
              ...
              <input
                ...
                placeholder="Search symbols, people, topics..."
                className="w-full bg-gray-200 rounded-full pl-8 pr-10 py-2 text-sm text-gray-900 placeholder:text-gray-400 outline-none focus:ring-1 focus:ring-[#2196F3]/50"
                autoFocus
              />
              {search && (
      ...
      {!isForYouPage && searchExpanded && (
        <div className="absolute left-0 right-0 bg-gray-50 z-30 overflow-y-auto" style={{ top: '94px', bottom: '260px' }}>
          {search.trim().length === 0 ? (
            <div className="px-4 pt-3 pb-6">
              {/* Recently Viewed */}
              <section className="mb-5">
                <h3 className="text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">Recently Viewed</h3>
                  ...
                  {[
                    ...
                    item.type === 'symbol' ? (
                      <button
                        ...
                        className="shrink-0 w-[110px] rounded-xl border border-gray-200 bg-gray-100 p-2.5 active:bg-gray-200"
                      >
                        {getTickerLogo(item.ticker) ? (
                          ...
                          <div className="w-10 h-10 mx-auto rounded-full bg-gray-200 flex items-center justify-center text-sm font-bold text-gray-600 mb-2">{item.ticker[0]}</div>
                        )}
                        <div className="text-xs font-bold text-center">{item.ticker}</div>
                        <div className="text-[10px] text-gray-500 text-center truncate">{item.name}</div>
                        {item.pct != null && (
                      ...
                      >
                        ...
                        <div className="text-[10px] text-gray-500 text-center">@{item.handle}</div>
                        {item.verified && (
              ...
              {/* Popular Searches */}
              <section>
                <h3 className="text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">Popular</h3>
                <div className="space-y-0">
                  {[
                    ...
                    <button
                      ...
                      className="flex items-center gap-3 w-full py-2.5 active:bg-gray-100 transition-colors"
                    >
                      <span className="text-base">{item.icon}</span>
                      <span className="flex-1 text-left text-sm">{item.label}</span>
                      <svg className="w-4 h-4 text-gray-900/20" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" d="M19 9l-7 7-7-7"/></svg>
                    </button>
                  ))}
                </div>
              </section>
            ...
            <div className="px-4 pt-3 pb-6">
              {!hasTypeaheadResults ? (
                <div className="text-center py-8">
                  <p className="text-sm text-gray-500 mb-3">No quick results for "{search}"</p>
                  <button
                    type="button"
                ...
                <>
                  ...
                  {stocksFiltered.length > 0 && (
                    <section className="mb-4">
                      <h3 className="text-xs font-bold text-gray-500 uppercase tracking-wide mb-2 px-1">Stocks</h3>
                      <div className="space-y-0">
                        {stocksFiltered.map(stock => (
                          <button
                            ...
                            className="flex items-center gap-3 w-full py-3 border-b border-gray-200 active:bg-gray-100"
                          >
                            {getTickerLogo(stock.ticker) ? (
                              <img src={getTickerLogo(stock.ticker)} alt="" className="w-10 h-10 rounded-full object-cover" />
                            ) : (
                              <div className="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center text-sm font-bold">{stock.ticker[0]}</div>
                            )}
                  ...
                  {cryptoFiltered.length > 0 && (
                    <section className="mb-4">
                      <h3 className="text-xs font-bold text-gray-500 uppercase tracking-wide mb-2 px-1">Crypto</h3>
                      <div className="space-y-0">
                        {cryptoFiltered.map(crypto => (
                          ...
                          >
                            {getTickerLogo(crypto.ticker) ? (
                              ...
                              <div className="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center text-sm font-bold">{crypto.ticker[0]}</div>
                            )}
                            <div className="flex-1 text-left min-w-0">
                  ...
                  {peopleFiltered.length > 0 && (
                    <section className="mb-4">
                      <h3 className="text-xs font-bold text-gray-500 uppercase tracking-wide mb-2 px-1">People</h3>
                      <div className="space-y-0">
          ...
          {TABS.map(tab => (
            <button
              ...
              className={clsx(
                ...
                activeTab === tab.id ? 'text-gray-900 border-gray-900' : 'text-gray-500 border-transparent'
              )}
            >
              {tab.label}
            </button>
      ...
      <div className={clsx('flex-1', activeTab === 'foryou' ? 'overflow-hidden' : 'overflow-y-auto')}>
        ...
        {activeTab === 'foryou' && (
          <div
            ref={fyContainerRef}
            className="h-full w-full relative bg-white select-none cursor-grab active:cursor-grabbing"
            ...
            {fyItem.type === 'video' && (
              <div className="absolute inset-0 flex flex-col">
                ...
                <div className="absolute bottom-4 left-0 right-14 px-4 z-10">
                  ...
                  {/* User info */}
                  <div className="flex items-center gap-2">
                    <img src={fyItem.user.avatar} alt="" className="w-8 h-8 rounded-full object-cover border border-white/30" />
                    <div className="flex items-center gap-1">
                      <span className="text-sm font-bold text-white">{fyItem.user.name}</span>
                    ...
                    <button type="button" className="ml-auto px-3 py-1 rounded-full text-xs font-semibold border border-white/40 text-white active:bg-white/10">
                      Follow
                    </button>
                  </div>
                    ...
                    <div className="flex items-center gap-2 mt-2.5">
                      <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-black/40 backdrop-blur-sm border border-white/20">
                        {getTickerLogo(fyItem.ticker) ? (
                          ...
                          <div className="w-5 h-5 rounded-full bg-white/20 flex items-center justify-center text-[9px] font-bold text-white">{fyItem.ticker[0]}</div>
                        )}
                        <span className="text-sm font-bold text-white">{fyItem.ticker}</span>
                        {fyItem.price != null && (
                ...
                <div className="absolute right-3 bottom-8 flex flex-col items-center gap-5 z-10">
                  ...
                  <button type="button" onClick={() => navigate('/notifications')} className="flex flex-col items-center gap-0.5">
                    ...
                    <span className="text-[10px] font-semibold text-white">{formatCount(fyItem.comments)}</span>
                  </button>
                  {/* Repost */}
                  <button type="button" className="flex flex-col items-center gap-0.5">
                    ...
                    <span className="text-[10px] font-semibold text-white">{formatCount(fyItem.reposts)}</span>
                  </button>
                  {/* Like */}
                  <button type="button" onClick={() => toggleFyLike(fyItem.id)} className="flex flex-col items-center gap-0.5">
                    ...
                    <span className="text-[10px] font-semibold text-white">{formatCount(fyLiked.has(fyItem.id) ? fyItem.likes + 1 : fyItem.likes)}</span>
                  </button>
                  {/* Share */}
                ...
                <div className="absolute bottom-4 left-0 right-14 px-4 z-10">
                  ...
                  {fyItem.ticker && (
                    <div className="flex items-center gap-2 mb-2">
                      {getTickerLogo(fyItem.ticker) && (
                        <img src={getTickerLogo(fyItem.ticker)} alt="" className="w-6 h-6 rounded-full object-cover border border-white/30" />
                      )}
                  ...
                  {/* Message body */}
                  <p className="text-[14px] text-white leading-snug">{fyItem.body}</p>
                  <span className="text-[11px] text-white/50 mt-1 block">{fyItem.time}</span>
                </div>
              ...
              <div className="absolute inset-0 flex flex-col bg-white">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none px-6" style={{ paddingBottom: '30%' }}>
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      <span className="text-3xl font-black tracking-tight text-white block">${fyItem.ticker}</span>
                      {fyItem.price != null && (
                ...
                <div className="absolute bottom-4 left-0 right-14 px-4 z-10">
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-[11px] text-white/50">· {fyItem.time}</span>
                  </div>
                  <p className="text-[14px] text-white leading-snug">{fyItem.body}</p>
                </div>
            ...
            {fyItem.type === 'message' && !fyItem.image && fyItem.layout !== 'full' && (() => {
              ...
              <div className="absolute inset-0 flex flex-col bg-gray-50">
                  ...
                  <div className="shrink-0 flex items-center gap-3 px-5 py-3">
                    ...
                    <div className="relative shrink-0">
                      {getTickerLogo(fyItem.ticker) ? (
                        ...
                        <div className="w-11 h-11 rounded-full bg-gray-200 flex items-center justify-center text-lg font-bold text-gray-600">{fyItem.ticker[0]}</div>
                      )}
                      <button
                        type="button"
                        onClick={() => toggleFyWatchlist(fyItem.ticker)}
                        className={clsx('absolute -bottom-1 -right-1 w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-bold border-2 border-white transition-colors', inWatchlist ? 'bg-green-500 text-white' : 'bg-[#2196F3] text-white')}
                      >
                        {inWatchlist ? (
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        <span className="text-xl font-black tracking-tight text-gray-900">${fyItem.ticker}</span>
                        {fyItem.price != null && (
                      ...
                      <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-500">Price Since Post</span>
                    </div>
                    {fyItem.pctChange != null && (
                ...
                <div className="shrink-0 px-4 relative" style={{ maxHeight: '70%', display: 'flex', flexDirection: 'column' }}>
                  <div
                    className="flex-1 overflow-y-auto rounded-t-2xl border border-b-0 border-gray-200 bg-gray-100"
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 p-4 pb-3">
                      <div className="relative">
                        <img src={fyItem.user.avatar} alt="" className="w-10 h-10 rounded-full object-cover border border-gray-300" />
                        {fyItem.user.badge && (
                      ...
                      <button
                        ...
                        className={clsx('px-3 py-1 rounded-full text-xs font-semibold transition-colors', isFollowed ? 'bg-gray-200 text-gray-600 border border-gray-300' : 'bg-[#2196F3] text-white')}
                      >
                      ...
                      <div className="px-4 pb-2 flex items-center gap-2">
                        {fyItem.sentiment === 'bullish' && (
                          <span className="inline-flex items-center gap-1 text-green-400 text-xs font-semibold">
                            <span className="w-4 h-4 rounded-full bg-green-500 flex items-center justify-center text-gray-900 text-[10px]">↑</span>
                          </span>
                        )}
                        {fyItem.sentiment === 'bearish' && (
                          <span className="inline-flex items-center gap-1 text-red-400 text-xs font-semibold">
                            <span className="w-4 h-4 rounded-full bg-red-500 flex items-center justify-center text-gray-900 text-[10px]">↓</span>
                          </span>
                        )}
                    ...
                    <div className="px-4 pb-3">
                      <p className="text-[15px] leading-relaxed whitespace-pre-line text-gray-900">{fyItem.body}</p>
                    </div>
                    {/* Embed if present */}
                    {fyItem.embed && (
                      <div className="mx-4 mb-3 rounded-xl border border-gray-200 overflow-hidden bg-black/5">
                        <div className="flex items-center gap-2 p-3 border-b border-gray-200">
                          <span className="text-sm">{fyItem.embed.sourceIcon}</span>
                          <span className="text-xs font-semibold text-gray-700">{fyItem.embed.source}</span>
                          {fyItem.user.verified && (
                          ...
                          <span className="ml-auto text-[10px] text-gray-400">{fyItem.embed.date}</span>
                        </div>
                        <div className="p-3">
                          <p className="text-[13px] leading-snug font-medium">{fyItem.embed.title}</p>
                          {fyItem.embed.hasChart && (
                            <div className="mt-3 h-32 bg-gray-50 rounded-lg border border-gray-200 flex items-center justify-center">
                  ...
                  >
                    ...
                    <div className="w-full bg-gray-100 flex justify-center pb-1">
                      <div className="flex flex-col items-center animate-bounce">
                        <svg className="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M19 9l-7 7-7-7" /></svg>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="shrink-0 px-4 pb-2">
                  <div className="w-full rounded-b-2xl border border-t-0 border-gray-200 bg-gray-100 overflow-hidden">
                    <div className="flex items-center justify-between px-4 py-3 border-t border-gray-200 text-gray-500">
                      <button type="button" onClick={() => navigate('/notifications')} className="flex items-center gap-1.5 active:text-gray-700 transition-colors">
                      ...
                      <button type="button" className="flex items-center gap-1.5 active:text-gray-700 transition-colors">
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/></svg>
                        <span className="text-xs">{fyItem.reposts}</span>
                      </button>
                      <button type="button" onClick={() => toggleFyLike(fyItem.id)} className={clsx('flex items-center gap-1.5 active:scale-110 transition-transform', fyLiked.has(fyItem.id) ? 'text-red-500' : 'text-gray-500')}>
                      ...
                      <button type="button" onClick={() => setShareSheetOpen(true)} className="active:text-gray-700 transition-colors">
          ...
          <div className="px-3 py-4 space-y-5">
            ...
            <section>
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  ...
                  <button type="button" className="flex items-center gap-0.5 text-xs text-gray-500">
                ...
                {TRENDING_NOW.map((s, idx) => {
                  ...
                  return (
                    <button
                      ...
                      className="shrink-0 w-[260px] rounded-xl border border-gray-200 bg-gray-100 p-3.5 text-left"
                    >
                      {/* Top row: logo + ticker info + rank badge */}
                      <div className="flex items-start justify-between mb-2">
                        <div className="flex items-center gap-2.5">
                          {logo ? (
                            <img src={logo} alt="" className="w-9 h-9 rounded-full object-cover bg-gray-200" />
                          ) : (
                            <div className="w-9 h-9 rounded-full bg-gray-200 flex items-center justify-center text-xs font-bold">{s.ticker[0]}</div>
                          )}
                          <div>
                        ...
                        <span className="text-2xl font-black text-gray-900/15 leading-none">#{idx + 1}</span>
                      </div>
                      {/* Description */}
                      <p className="text-[12px] text-gray-500 leading-relaxed line-clamp-4">{s.whyBlurb}</p>
                    </button>
                  )
                })}
              </div>
            ...
            <section>
              ...
              <div className="flex gap-2 overflow-x-auto pb-1 -mx-3 px-3" style={{ scrollbarWidth: 'none' }}>
                {LIVE_EARNINGS.map(e => (
                  <div key={e.ticker} className="shrink-0 w-[130px] rounded-xl border border-gray-200 bg-gray-100 p-2.5">
                    ...
                    <div className="text-[10px] text-gray-500">🎧 {e.listeners} listening</div>
                    <div className="text-[10px] text-gray-400">Started {e.started}</div>
                  </div>
                ))}
              </div>
            </section>
            ...
            <section>
              ...
              <div className="flex gap-2.5 overflow-x-auto pb-1 -mx-3 px-3" style={{ scrollbarWidth: 'none' }}>
                {TRENDING_NEWS.map((art, i) => {
                  ...
                  return (
                    <div key={`overview-news-${i}`} className="shrink-0 w-[220px] rounded-xl overflow-hidden border border-gray-200 bg-gray-100">
                      <div className="relative aspect-video bg-gray-100">
                        ...
                        {art.ticker && (
                          <span className={clsx('absolute top-1.5 left-1.5 px-1.5 py-0.5 rounded text-[10px] font-semibold', up ? 'bg-green-500/90 text-gray-900' : 'bg-red-500/90 text-gray-900')}>
                      ...
                      <div className="p-2.5">
                        ...
                        <p className="text-[10px] text-gray-500 mt-0.5">{art.meta}</p>
                      </div>
                    </div>
                  )
                })}
            ...
            <section>
                ...
                {WTF_CATEGORIES.map(cat => (
                  <button
                    ...
                    className={clsx(
                      ...
                      wtfCat === cat ? 'bg-[#2196F3] text-white border-[#2196F3]' : 'bg-transparent text-gray-500 border-gray-200'
                    )}
                  >
                    {cat}
                  </button>
              ...
              <div className="flex gap-2.5 overflow-x-auto pb-1 -mx-3 px-3 mt-1" style={{ scrollbarWidth: 'none' }}>
                {(WTF_PEOPLE[wtfCat] || []).map(person => (
                  <div key={person.handle} className="shrink-0 w-[150px] flex flex-col items-center rounded-xl border border-gray-200 bg-gray-100 p-3 text-center">
                    <img src={person.avatar} alt="" className="w-11 h-11 rounded-full object-cover mb-2 bg-gray-200" />
                    ...
                    <span className="text-[9px] text-gray-400 mb-1">@{person.handle}</span>
                    <p className="text-[9px] text-gray-500 leading-tight line-clamp-2 mb-1.5 min-h-[22px]">{person.bio}</p>
                    <span className="text-[9px] text-gray-400 mb-2">{person.followers} followers</span>
            ...
            <section>
              ...
              <div className="flex gap-2 overflow-x-auto pb-1 -mx-3 px-3" style={{ scrollbarWidth: 'none' }}>
                {TOP_WATCHLIST_ADDS.map(w => (
                  <div key={w.ticker} className="shrink-0 flex items-center gap-2 rounded-xl border border-gray-200 bg-gray-100 px-3 py-2">
                    ...
                    <div>
                      ...
                      <div className="text-[10px] text-gray-500">+{w.adds} adds</div>
                    </div>
            ...
            <section>
              ...
              <div className="flex gap-3 overflow-x-auto pb-1 -mx-3 px-3" style={{ scrollbarWidth: 'none' }}>
                {TOP_TOPICS.map(t => (
                  <div key={t.label} className="shrink-0 w-[180px] rounded-xl border border-gray-200 bg-gray-100 p-3">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="text-lg">{t.emoji}</span>
                      <div className="min-w-0">
                        <div className="text-xs font-semibold leading-tight">{t.label}</div>
                        <div className="text-[10px] text-gray-500">{t.count} posts</div>
                      </div>
                    </div>
                    <div className="flex flex-wrap gap-1.5">
                      {t.tickers.map(ticker => (
                        <button
                          ...
                          className="flex items-center gap-1 px-2 py-1 rounded-full bg-gray-200 active:bg-gray-200 transition-colors"
                        >
                          {getTickerLogo(ticker) ? (
                            <img src={getTickerLogo(ticker)} alt="" className="w-4 h-4 rounded-full object-cover" />
                          ) : (
                            <span className="w-4 h-4 rounded-full bg-gray-200 flex items-center justify-center text-[8px] font-bold">{ticker[0]}</span>
                          )}
                          <span className="text-[10px] font-semibold text-gray-800">{ticker}</span>
                        </button>
                      ))}
                    </div>
                  </div>
              ...
              <div className="space-y-0 divide-y divide-white/5">
                {PREDICTION_LEADERBOARD.map(p => (
                  <div key={p.rank} className="flex items-center gap-3 py-2.5">
                    <span className="text-xs font-bold text-gray-400 w-4 text-right">{p.rank}</span>
                    <img src={p.avatar} alt="" className="w-8 h-8 rounded-full object-cover bg-gray-200" />
                    <div className="flex-1 min-w-0">
            ...
            <section>
              ...
              <div className="flex gap-3 overflow-x-auto pb-1 -mx-3 px-3" style={{ scrollbarWidth: 'none' }}>
                {TOP_DISCUSSIONS.map(poll => (
                  <div key={poll.id} className="shrink-0 w-[260px] rounded-xl border border-gray-200 bg-gray-100 p-3 flex flex-col">
                    <p className="text-[13px] font-semibold leading-snug line-clamp-2 mb-2">{poll.question}</p>
                    <div className="flex flex-wrap gap-1.5 mb-2">
                      {poll.choices.map(c => (
                        <span key={c} className="px-2.5 py-1 rounded-full text-[11px] border border-gray-200 text-gray-600">{c}</span>
                      ))}
                    </div>
                    <div className="mt-auto flex items-center justify-between text-[10px] text-gray-400 pt-2 border-t border-gray-200">
                      <div className="flex items-center gap-2">
          ...
          <div className="px-3 py-4 space-y-5">
            ...
            <section>
              ...
              {COMMUNITY_FOCUS.slice(0, 1).map((art, i) => (
                <div key={i} className="relative rounded-xl overflow-hidden aspect-[16/9] bg-gray-100">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-3">
                    <h3 className="text-sm font-bold leading-snug text-white">{art.headline}</h3>
              ...
              <div className="mt-3 space-y-3">
                {COMMUNITY_FOCUS.slice(1).map((art, i) => (
                  <div key={i} className="flex gap-3 active:bg-gray-100 rounded-lg p-1 -m-1">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[11px] text-gray-500 mt-0.5">{art.author} • {art.time}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <section>
                ...
                {SECTOR_CATEGORIES.map(cat => (
                  <button
                    ...
                    className={clsx(
                      ...
                      sectorFilter === cat ? 'bg-[#2196F3] text-white' : 'bg-gray-200 text-gray-600'
                    )}
                  >
              ...
              <div className="flex gap-2.5 overflow-x-auto pb-1 -mx-3 px-3 mt-1" style={{ scrollbarWidth: 'none' }}>
                {(SECTOR_ARTICLES[sectorFilter] || []).map((art, i) => {
                  const up = (art.pct ?? 0) >= 0
                  return (
                    <div key={i} className="shrink-0 w-[200px] rounded-xl overflow-hidden border border-gray-200 bg-gray-100">
                      <div className="relative aspect-video bg-gray-100">
                        <img src={art.image} alt="" className="w-full h-full object-cover" />
                        {art.video && (
                          <div className="absolute inset-0 flex items-center justify-center bg-black/5">
                      ...
                      <div className="p-2.5">
                        <h4 className="text-xs font-semibold line-clamp-2 leading-snug">{art.title}</h4>
                        <p className="text-[10px] text-gray-500 mt-0.5">{art.source} • {art.time}</p>
                      </div>
                    </div>
                  )
                })}
            ...
            <section>
              ...
              <div className="flex gap-2.5 overflow-x-auto pb-1 -mx-3 px-3" style={{ scrollbarWidth: 'none' }}>
                {SHOWS.map((show, i) => (
                  <div key={i} className="shrink-0 w-[160px] rounded-xl overflow-hidden border border-gray-200 bg-gray-100">
                    ...
                    <div className="p-2.5">
                      ...
                      <p className="text-[10px] text-gray-500 mt-0.5 line-clamp-1">{show.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
        ...
        {activeTab === 'earnings' && (
          <div className="px-3 py-4 space-y-4">
              ...
              <div className="flex gap-2 overflow-x-auto pb-1 -mx-3 px-3" style={{ scrollbarWidth: 'none' }}>
                {LIVE_EARNINGS.map((e) => (
                  <Link
                    key={e.ticker}
                    to={`/symbol/${e.ticker}`}
                    className="shrink-0 w-[130px] rounded-xl border border-gray-200 bg-gray-100 p-2.5"
                  >
                    <div className="flex items-center gap-1.5 mb-1">
                      {getTickerLogo(e.ticker) && (
                        <img src={getTickerLogo(e.ticker)} alt="" className="w-5 h-5 rounded-full object-cover" />
                      )}
                      <span className="text-xs font-bold text-gray-900">{e.ticker}</span>
                    </div>
                    <div className="text-[10px] text-gray-500">🎧 {e.listeners} listening</div>
                    <div className="text-[10px] text-gray-400">Started {e.started}</div>
                  </Link>
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex items-center gap-1.5">
                <button type="button" className="p-1 rounded-lg text-gray-500" aria-label="Previous week">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg>
                </button>
                <span className="text-[11px] font-medium text-gray-700">Week of 2/09/2026</span>
                <button type="button" className="p-1 rounded-lg text-gray-500" aria-label="Next week">
                ...
                return (
                  <button
                    ...
                    className={clsx(
                      ...
                      isSelected ? 'bg-[#2196F3] border-[#2196F3]' : 'bg-gray-100 border-gray-200'
                    )}
                  >
                    <div className={clsx('text-[9px] font-bold uppercase tracking-wider mb-0.5', isSelected ? 'text-white/80' : 'text-gray-500')}>{day.label}</div>
                    <div className={clsx('text-xl font-bold', isSelected ? 'text-white' : 'text-gray-900')}>{day.date}</div>
                    <div className={clsx('text-[10px] leading-tight line-clamp-2 mt-1', isSelected ? 'text-white/80' : 'text-gray-500')}>
                      {tickerText} {preview.total > 0 && `reporting`}
                    </div>
                    <div className={clsx('text-[10px] font-semibold mt-1', isSelected ? 'text-white/70' : 'text-gray-500')}>{preview.total} reporting</div>
                  </button>
                )
              })}
            </div>
                ...
                <table className="w-full text-[11px]">
                  <thead>
                    <tr className="border-b border-gray-200 bg-gray-100">
                      ...
                      <th className="text-right py-2 px-2 font-semibold text-gray-900">%Chg</th>
                      ...
                      <th className="text-left py-2 px-2 font-semibold text-gray-900">Report</th>
                  ...
                  <tbody>
                    {earningsDayRows.map((row) => {
                      ...
                      return (
                        <tr key={row.ticker} className="border-b border-gray-200 last:border-0">
                          <td className="py-2.5 px-2">
                            <Link to={`/symbol/${row.ticker}`} className="flex items-center gap-1.5">
                              {getTickerLogo(row.ticker) ? (
                                ...
                                <div className="w-5 h-5 rounded-full bg-gray-200 flex items-center justify-center text-[9px] font-bold">{row.ticker[0]}</div>
                              )}
                              <span className="font-semibold text-gray-900">{row.ticker}</span>
                            </Link>
                          </td>
                          <td className="py-2.5 px-2 text-right text-gray-900">${row.price.toFixed(2)}</td>
                          ...
                          <td className="py-2.5 px-2 text-right text-gray-500">{row.watchers.toLocaleString()}</td>
                          <td className="py-2.5 px-2 text-gray-500">{row.reporting}</td>
                          <td className="py-2.5 px-2 text-center">
                            <button
                              ...
                              className={clsx(
                                ...
                                watched ? 'bg-[#2196F3] text-white' : 'bg-gray-200 text-gray-500'
                              )}
                            >
                              {watched ? (
